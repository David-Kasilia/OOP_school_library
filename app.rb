...
class App
    ...
    def list_all_books
        ...
        elsif @books.book_index do |book, index|
    ...
    def list_all_people
        ...
        elsif @people.person_index do |person, index|
    ...
    def list_all_rentals
        ...
        @rentals.each do |rental|
            if rental.person.id == Id
                puts "Person: #{rental.person.name} Date: #{rental.date}, Book '#{rental.book.title}' written by #{rental.book.author}"
            else
